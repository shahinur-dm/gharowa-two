      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
        ...
        <div className="lg:col-span-5 space-y-6">
          <div className="p-7 rounded-3xl bg-white border border-slate-200 shadow-card space-y-6 text-xs sm:text-sm text-slate-700">
            <div>
              <span className="text-[10px] font-bold uppercase tracking-wider text-traditional-700 bg-traditional-50 px-2.5 py-1 rounded-full border border-traditional-200">
                Flagship Location
              </span>
              <h2 className="text-xl font-bold text-slate-900 font-bengali mt-2">
