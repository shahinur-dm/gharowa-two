  ...
  return (
    <div className="space-y-16 py-10 pb-20">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center space-y-4">
        ...
        <p className="text-xs sm:text-sm text-slate-600 font-bengali max-w-2xl mx-auto leading-relaxed">
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-center">
          ...
          <div className="lg:col-span-6 space-y-5 text-slate-700 font-bengali text-xs sm:text-sm leading-relaxed">
            ...
            <p>
              আমাদের ঐতিহ্যবাহী <strong>খাসির ভুনা খিচুড়ি</strong> এবং <strong>লেগ খিচুড়ি</strong> ঢাকার রসনাবিলাসে এক অনন্য দৃষ্টান্ত। প্রতিটি পাত্রে আমরা নিশ্চিত করি নিখুঁত খাঁটি গাওয়া ঘি, পরিচ্ছন্ন রান্নাবান্না এবং পরম যত্নে তৈরি আপ্যায়ন।
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-card space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 font-bengali">স্বাদে আপসহীন গুণমান</h3>
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-card space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 font-bengali">স্বাস্থ্য ও পরিচ্ছন্নতা</h3>
            <p className="text-xs text-slate-600 leading-relaxed font-bengali">
          ...
          <div className="p-6 rounded-3xl bg-white border border-slate-200 shadow-card space-y-3">
            ...
            <h3 className="text-base font-bold text-slate-900 font-bengali">ঘরোয়া আতিথেয়তা</h3>
            <p className="text-xs text-slate-600 leading-relaxed font-bengali">
