            ...
            <div className="p-5 border-b border-slate-200 flex items-center justify-between bg-slate-50/80">
              <div className="flex items-center gap-2.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-traditional-700 font-bold">
                    {language === 'bn'
            ...
            {items.length > 0 && (
              <div className="p-5 border-t border-slate-200 bg-slate-50 space-y-4">
                ...
                <div className="space-y-1.5 text-xs text-slate-700 border-t border-slate-200 pt-3">
                  ...
                  <div className="flex justify-between text-sm font-extrabold text-traditional-700 pt-2 border-t border-slate-200">
                    <span>{language === 'bn' ? 'সর্বমোট প্রদেয়:' : 'Grand Total:'}</span>
                    <span className="font-mono text-base">{formatPrice(grandTotal, language)}</span>
                  </div>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-2xl bg-traditional-700 hover:bg-traditional-800 text-white font-bold text-xs sm:text-sm flex items-center justify-center gap-2 shadow-red transition-all active:scale-[0.99]"
                >
