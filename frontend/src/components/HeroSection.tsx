...
export default function HeroSection({ settings }: HeroSectionProps) {
  ...
  return (
    <section className="relative overflow-hidden bg-gradient-to-b from-[#800A15] via-[#900C19] to-[#680811] text-white pt-24 pb-16 sm:pt-28 lg:pt-32 lg:pb-24 border-b border-white/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-14 items-center">
          ...
          <div className="lg:col-span-6 space-y-6 text-center lg:text-left">
            {/* Top Authentic Tag */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-white/10 border border-white/20 text-amber-300 text-xs font-medium tracking-wider uppercase backdrop-blur-sm shadow-sm">
              <Sparkles className="w-3.5 h-3.5 text-amber-400 animate-pulse" />
              <span>{badgeText}</span>
            </div>

            {/* Main Clean Sans Headline */}
            <h1 className="text-3xl sm:text-4xl lg:text-[54px] font-semibold tracking-tight text-white leading-[1.18] font-sans">
              {title}
            </h1>

            {/* Subtitle */}
            <p className="text-[15px] sm:text-base lg:text-[17px] text-white/90 font-bengali font-normal max-w-xl mx-auto lg:mx-0 leading-relaxed">
              {subtitle}
            </p>
            ...
            <div className="flex flex-wrap items-center justify-center lg:justify-start gap-4 pt-2">
              ...
              <Link
                ...
                className="px-7 py-3 rounded-full bg-white hover:bg-amber-50 text-[#900C19] font-semibold text-sm shadow-xl hover:shadow-2xl transition-all duration-300 transform active:scale-95 flex items-center gap-2 tracking-normal"
              >
              ...
              <Link
                href="/menu"
                className="px-6 py-3 rounded-full bg-white/15 hover:bg-white/25 border border-white/30 text-white font-semibold text-sm backdrop-blur-sm transition-all duration-300 flex items-center gap-2 tracking-normal"
              >
            ...
            <div className="pt-6 border-t border-white/15 flex flex-wrap items-center justify-center lg:justify-start gap-6 sm:gap-8 text-xs text-white/90">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-semibold text-white text-sm">4.9 / 5.0</div>
                  <div className="text-[11px] text-white/70 font-normal">{language === 'bn' ? 'রেটিং' : 'Highly Rated'}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-semibold text-white text-sm">#১ বেস্টসেলার</div>
                  <div className="text-[11px] text-white/70 font-normal">{language === 'bn' ? 'জনপ্রিয় খাবার' : 'Best Seller'}</div>
                </div>
              </div>
              ...
              <div className="flex items-center gap-2">
                ...
                <div>
                  <div className="font-semibold text-white text-sm">৩০–৪৫ মিনিট</div>
                  <div className="text-[11px] text-white/70 font-normal">{language === 'bn' ? 'দ্রুত ডেলিভারি' : 'Fast Delivery'}</div>
                </div>
              </div>
            </div>
          </div>
