    ...
    <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-6 text-center sm:text-left">
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/menu"
            className="inline-flex items-center gap-1.5 px-4 py-1.5 rounded-full border border-[#900C19]/30 text-[#900C19] hover:bg-[#900C19] hover:text-white font-bold text-xs transition-all shadow-sm group"
          >
