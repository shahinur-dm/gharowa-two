      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
        ...
        <div className="lg:col-span-5 bg-white rounded-3xl p-6 sm:p-8 border border-slate-200/80 shadow-sm space-y-6 flex flex-col justify-between">
          <div className="space-y-5">
            ...
            <div className="space-y-4 text-xs text-slate-600">
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-slate-800">{language === 'bn' ? 'ঠিকানা' : 'Address'}</div>
                  <div>{address}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-slate-800">{language === 'bn' ? 'হটলাইন' : 'Phone'}</div>
                  <a href={`tel:${phone}`} className="hover:text-[#900C19] font-medium">{phone}</a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-slate-800">{language === 'bn' ? 'ইমেইল' : 'Email'}</div>
                  <div>{email}</div>
                </div>
              </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  <div className="font-bold text-slate-800">{language === 'bn' ? 'খোলার সময়' : 'Opening Hours'}</div>
                  <div>{hours}</div>
                </div>
              </div>
            </div>
          ...
          <a
            ...
            className="w-full py-3 rounded-2xl bg-emerald-600 hover:bg-emerald-700 text-white font-bold text-xs flex items-center justify-center gap-2 shadow-md transition-all active:scale-95"
          >
            ...
            <form onSubmit={handleSubmit} className="space-y-4 text-xs">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 focus:outline-none focus:border-[#900C19] transition-colors"
                />
              </div>

              <div>
                <label className="block font-semibold text-slate-700 mb-1">
                  {language === 'bn' ? 'ফোন নম্বর বা ইমেইল *' : 'Phone / Email *'}
                </label>
                <input
                  type="text"
                  required
                  ...
                  placeholder={language === 'bn' ? 'মোবাইল নম্বর বা ইমেইল' : 'Phone number or email'}
                  className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 focus:outline-none focus:border-[#900C19] transition-colors"
                />
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder={language === 'bn' ? 'আপনার মতামত বা ক্যাটারিং সংক্রান্ত জিজ্ঞাসা লিখুন...' : 'Write your inquiry or feedback...'}
                  className="w-full px-4 py-2.5 rounded-xl bg-slate-50 border border-slate-200 text-slate-800 focus:outline-none focus:border-[#900C19] transition-colors"
                />
              </div>
