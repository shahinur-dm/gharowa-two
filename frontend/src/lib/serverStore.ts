...
export const defaultSettings = {
  ...
  chefName: 'Master Chef Rafiqul Islam',
  ...
  chefBio: 'তিন দশক ধরে ঘরোয়ার সিগনেচার খাসির ভুনা খিচুড়ি ও কাচ্চির আসল স্বাদ সংরক্ষণ করে আসছেন।',
  ...
  ownerName: 'Haji Mohammad Nur Hossain',
  ownerNameBn: 'হাজী মোহাম্মদ নূর হোসেন',
  ownerNameEn: 'Haji Mohammad Nur Hossain',
  ownerDesignation: 'Founder & Proprietor',
  ownerTitleBn: 'প্রতিষ্ঠাতা ও স্বত্বাধিকারী',
  ownerTitleEn: 'Founder & Proprietor',
  ownerQuote: 'খাবারের মানের সাথে কোনো আপস নয় — এটাই ১৯৭২ সাল থেকে আমাদের প্রতিজ্ঞা।',
